...
module.exports.run = (bot, message, args) => {
  ...
  msgArray.push(`I'm currently running on Discord.js version ${pkg.version} which utilizes the latest version of Discord.js, an *unofficial* Discord libary by hydrabolt.`);

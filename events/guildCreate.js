...
module.exports = (bot, guild, discord) => {
  ...
  .addField("Heyo! Thanks for adding me to your server. Before you start using me, I need to get some things straight. First of all, for some basic info about me, say `h!info`.")
